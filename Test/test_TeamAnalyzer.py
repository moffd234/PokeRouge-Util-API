...
from Application.Utils.TeamAnalyzer import get_team_resistances


def test_get_team_resistances_full_team():
...
def test_get_team_resistances_none():
    team: list[Pokemon] = []
    expected: dict = {"normal": 0, "fire": 0, "water": 0, "electric": 0, "grass": 0, "ice": 0, "fighting": 0,
                      "poison": 0, "ground": 0, "flying": 0, "psychic": 0, "bug": 0, "rock": 0, "ghost": 0,
