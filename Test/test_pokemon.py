...
def test_pokemon_repr():
    example_pokemon = Pokemon.query.filter_by(name="BULBASAUR").first()
    expected: str = f"<Pokemon {example_pokemon.name} (Gen {example_pokemon.generation}, Type: {example_pokemon.type_1} {example_pokemon.type_2})>"
    actual: str = repr(example_pokemon)
