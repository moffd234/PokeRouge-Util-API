...
class Types(Enum):
    ...
    WATER = (['Fire', "Ground", "Rock"], ["Grass", "Electric"], ["Steel", "Water", "Frre", "Ice"],
             ["Water", "Grass", "Dragon"], [], [])
    GRASS = (["Water", "Ground", "Rock"], ["Fire", "Flying", "Bug", "Poison", "Ice"], ["Grass", "Water", "Fire", "Ice"],
             ["Water", "Grass", "Dragon"], [], [])
